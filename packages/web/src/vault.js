...
exports.getPermutations = (subset /*: number */) /*: string */ => getNumberWord(permutations(data.length, subset))
...
async function fetch(
  ...
  try {
    ...
    if (analysis.score < scoreThreshold) {
      throw new Error(`Passphrase ${phrase} score did not meet threshold ${scoreThreshold}`);
    }
